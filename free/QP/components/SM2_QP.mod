...
var cos_norm {t in time, (n,m) in buspair: Ccond[t,n,m]} = sqrt( (cv1[t,n,m]*cv3[t,n,m]+lambda14[t,n,m]*lambda16[t,n,m])^2 + (cv2[t,n,m]*cv3[t,n,m]+lambda15[t,n,m]*lambda16[t,n,m])^2 );
var cos_l1 {t in time, (n,m) in buspair: Ccond[t,n,m]} = sqrt( 2*eps^2 + cv1[t,n,m]^2 + cv2[t,n,m]^2 + cv3[t,n,m]^2 + lambda14[t,n,m]^2 + lambda15[t,n,m]^2 + lambda16[t,n,m]^2 - 2*cos_norm[t,n,m] );
var cos_l2 {t in time, (n,m) in buspair: Ccond[t,n,m]} = sqrt( 2*eps^2 + cv1[t,n,m]^2 + cv2[t,n,m]^2 + cv3[t,n,m]^2 + lambda14[t,n,m]^2 + lambda15[t,n,m]^2 + lambda16[t,n,m]^2 + 2*cos_norm[t,n,m] );

var vsoa_norm {t in time, (l,n,m) in branch_from: Vcond[t,l,n,m]} = sqrt( (v1[t,l,n,m]*v4[t,l,n,m]+lambda17[t,l,n,m]*lambda20[t,l,n,m])^2 + (v2[t,l,n,m]*v4[t,l,n,m]+lambda18[t,l,n,m]*lambda20[t,l,n,m])^2 + (v3[t,l,n,m]*v4[t,l,n,m]+lambda19[t,l,n,m]*lambda20[t,l,n,m])^2 );
var vsoa_l1 {t in time, (l,n,m) in branch_from: Vcond[t,l,n,m]} = sqrt( 2*eps^2 + v1[t,l,n,m]^2 + v2[t,l,n,m]^2 + v3[t,l,n,m]^2 + v4[t,l,n,m]^2 + lambda17[t,l,n,m]^2 + lambda18[t,l,n,m]^2 + lambda19[t,l,n,m]^2 + lambda20[t,l,n,m]^2 - 2*vsoa_norm[t,l,n,m] );
var vsoa_l2 {t in time, (l,n,m) in branch_from: Vcond[t,l,n,m]} = sqrt( 2*eps^2 + v1[t,l,n,m]^2 + v2[t,l,n,m]^2 + v3[t,l,n,m]^2 + v4[t,l,n,m]^2 + lambda17[t,l,n,m]^2 + lambda18[t,l,n,m]^2 + lambda19[t,l,n,m]^2 + lambda20[t,l,n,m]^2 + 2*vsoa_norm[t,l,n,m] );

var pq_norm {t in time, (l,n,m) in branch: Scond[t,l,n,m]} = sqrt( (P[t,l,n,m]*Sl_max[l] + lambda11[t,l,n,m]*lambda13[t,l,n,m])^2 + (Q[t,l,n,m]*Sl_max[l] + lambda12[t,l,n,m]*lambda13[t,l,n,m])^2 );
var pq_l1 {t in time, (l,n,m) in branch: Scond[t,l,n,m]} = sqrt( 2*eps^2 + P[t,l,n,m]^2 + Q[t,l,n,m]^2 + Sl_max[l]^2 + lambda11[t,l,n,m]^2 + lambda12[t,l,n,m]^2 + lambda13[t,l,n,m]^2 - 2*pq_norm[t,l,n,m] );
var pq_l2 {t in time, (l,n,m) in branch: Scond[t,l,n,m]} = sqrt( 2*eps^2 + P[t,l,n,m]^2 + Q[t,l,n,m]^2 + Sl_max[l]^2 + lambda11[t,l,n,m]^2 + lambda12[t,l,n,m]^2 + lambda13[t,l,n,m]^2 + 2*pq_norm[t,l,n,m] );
...
subject to cosa_cc3 {t in time, (n,m) in buspair: Ccond[t,n,m]}:
 cv3[t,n,m]+lambda16[t,n,m] - (cos_l1[t,n,m] + cos_l2[t,n,m])/2 = 0;

subject to cosa_cc1 {t in time, (n,m) in buspair: Ccond[t,n,m]}:
(cv1[t,n,m]+lambda14[t,n,m]) - (cv1[t,n,m]*cv3[t,n,m]+lambda14[t,n,m]*lambda16[t,n,m])*(-cos_l1[t,n,m] + cos_l2[t,n,m])/cos_norm[t,n,m]/2 = 0;

subject to cosa_cc2 {t in time, (n,m) in buspair: Ccond[t,n,m]}:
(cv2[t,n,m]+lambda15[t,n,m]) - (cv2[t,n,m]*cv3[t,n,m]+lambda15[t,n,m]*lambda16[t,n,m])*(-cos_l1[t,n,m] + cos_l2[t,n,m])/cos_norm[t,n,m]/2 = 0;


subject to vsoa_cc4 {t in time, (l,n,m) in branch_from: Vcond[t,l,n,m]}:
 v4[t,l,n,m]+lambda20[t,l,n,m] - (vsoa_l1[t,l,n,m] + vsoa_l2[t,l,n,m])/2 = 0;

subject to vsoa_cc1 {t in time, (l,n,m) in branch_from: Vcond[t,l,n,m]}:
 v1[t,l,n,m]+lambda17[t,l,n,m] - (v1[t,l,n,m]*v4[t,l,n,m]+lambda17[t,l,n,m]*lambda20[t,l,n,m])*(-vsoa_l1[t,l,n,m] + vsoa_l2[t,l,n,m])/vsoa_norm[t,l,n,m]/2 = 0;

subject to vsoa_cc2 {t in time, (l,n,m) in branch_from: Vcond[t,l,n,m]}:
 v2[t,l,n,m]+lambda18[t,l,n,m] - (v2[t,l,n,m]*v4[t,l,n,m]+lambda18[t,l,n,m]*lambda20[t,l,n,m])*(-vsoa_l1[t,l,n,m] + vsoa_l2[t,l,n,m])/vsoa_norm[t,l,n,m]/2 = 0;

subject to vsoa_cc3 {t in time, (l,n,m) in branch_from: Vcond[t,l,n,m]}:
 v3[t,l,n,m]+lambda19[t,l,n,m] - (v3[t,l,n,m]*v4[t,l,n,m]+lambda19[t,l,n,m]*lambda20[t,l,n,m])*(-vsoa_l1[t,l,n,m] + vsoa_l2[t,l,n,m])/vsoa_norm[t,l,n,m]/2 = 0;


subject to pqmax_cc3 {t in time, (l,n,m) in branch: Scond[t,l,n,m]}:
 Sl_max[l]+lambda13[t,l,n,m] - (pq_l1[t,l,n,m] + pq_l2[t,l,n,m])/2 = 0;

subject to pqmax_cc1 {t in time, (l,n,m) in branch: Scond[t,l,n,m]}:
 P[t,l,n,m]+lambda11[t,l,n,m] - (P[t,l,n,m]*Sl_max[l] + lambda11[t,l,n,m]*lambda13[t,l,n,m])*(-pq_l1[t,l,n,m] + pq_l2[t,l,n,m])/pq_norm[t,l,n,m]/2 = 0;

subject to pqmax_cc2 {t in time, (l,n,m) in branch: Scond[t,l,n,m]}:
 Q[t,l,n,m]+lambda12[t,l,n,m] - (Q[t,l,n,m]*Sl_max[l] + lambda12[t,l,n,m]*lambda13[t,l,n,m])*(-pq_l1[t,l,n,m] + pq_l2[t,l,n,m])/pq_norm[t,l,n,m]/2 = 0;
