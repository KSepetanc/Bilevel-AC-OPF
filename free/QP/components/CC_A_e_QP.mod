...
subject to cc_A:
 sum {t in time, g in gen} ( pg_max[g] - Pgen[t,g])*mi1max[t,g]
+sum {t in time, g in gen} (-pg_min[g] + Pgen[t,g])*mi1min[t,g]
+sum {t in time, g in gen} ( qg_max[g] - Qgen[t,g])*mi2max[t,g]
+sum {t in time, g in gen} (-qg_min[g] + Qgen[t,g])*mi2min[t,g]
+sum {t in time, n in bus} ( vmax[n] - dV[t,n] - Vt[t,n])*mi3max[t,n]
+sum {t in time, n in bus} (-vmin[n] + dV[t,n] + Vt[t,n])*mi3min[t,n]
+sum {t in time, (n,m) in buspair: Ccond[t,n,m]} (lambda14[t,n,m]*cv1[t,n,m] + lambda15[t,n,m]*cv2[t,n,m] + lambda16[t,n,m]*cv3[t,n,m])
+sum {t in time, (l,n,m) in branch_from: Vcond[t,l,n,m]} (lambda17[t,l,n,m]*v1[t,l,n,m] + lambda18[t,l,n,m]*v2[t,l,n,m] + lambda19[t,l,n,m]*v3[t,l,n,m] + lambda20[t,l,n,m]*v4[t,l,n,m])
+sum {t in time, (l,n,m) in branch: Scond[t,l,n,m]} (lambda11[t,l,n,m]*P[t,l,n,m] + lambda12[t,l,n,m]*Q[t,l,n,m] + lambda13[t,l,n,m]*Sl_max[l])
<= 
  eps*
  (4*card(time)*card(gen)+2*card(time)*card(bus) 
  + sum {t in time, (n,m) in buspair: Ccond[t,n,m]} 1
  + sum {t in time, (l,n,m) in branch_from: Vcond[t,l,n,m]} 1
  + sum {t in time, (l,n,m) in branch: Scond[t,l,n,m]} 1);
